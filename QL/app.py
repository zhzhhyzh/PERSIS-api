...
def update_q_table(message, persuasive_type, activity, reward, question_id, learning_rate=0.1, gamma=0.99):
    ...
    if reward == 1:
        ...
        new_value = previous_value + learning_rate*(-1.0)  # Reduce penalty to avoid eliminating types too quickly
